...
SCHEMA: list[VarSchema] = [
    ...
    VarSchema("SHOW_MOONRISE_MOONSET_DURING_DAYTIME", "Show Moonrise &amp; Moonset During Daytime",          VarType.BOOLEAN,
              "Display moonrise and moonset times that occur during daytime hours", readonly=True,
              group="Moonrise &amp; Moonset"),
